...
class conditional_ {
	public:
		conditional_() { scopec = 0; }
		virtual ~conditional_() {}
		virtual void init() = 0;
...
class cond_mgr { 
	public:
		static void init_cond(conditional_* c);
	...
	private:
		...
		static std::stack<conditional_*>* conditional_heap;
		static int uid;
		
};

class if_cnd : public conditional_ {
	public:
...
class while_cnd: public conditional_ {
	public:
...
class for_cnd: public conditional_ {
	public:
