...
class type {
	public:
		...
		// modified by ahmed 3-feb-2024
		//virtual const type* dereference() const
		virtual const type* dereference() const
			// removed by ahmed 3-feb-2024
...
class t_ptr : public type {
	public:
		...
		virtual bool operator==(const type& t) const // modifeid by ahmed 3-feb-2024
		{
			try {
		...
		virtual const type* dereference() const noexcept 
			// removed by ahmed 3-feb-2024
			//const throw(const not_a_reference*)
		{
			return ref;
...
public:
	...
	// modified by ahmed on 4-feb-2024	
	virtual const type* dereference() const noexcept
		// deleted by ahmed on 4-feb-2024	
		//const throw(const not_a_reference*)
	{
		return base;
	}
