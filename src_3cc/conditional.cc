...
int cond_mgr::uid;
std::stack<conditional_*>* cond_mgr::conditional_heap = NULL;

void cond_mgr::init_condheap() {
	if(conditional_heap == NULL) 
		conditional_heap = new std::stack<conditional_*>();
}

void cond_mgr::init_cond(conditional_* c) {
	init_condheap();
